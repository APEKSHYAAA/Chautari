    ...
    const Table = ({ list, searchQuery, onUserSelect }) => {
      ...
      const handleUserClick = (user) => {
        console.log("Table: handleUserClick called with user:", user);
        setSelectedUser(user);
        if (onUserSelect) {
          console.log("Table: onUserSelect is defined, calling it");
          onUserSelect(user);
        } else {
          console.log("Table: onUserSelect is not defined");
        }
      };
    ...
    const Page = ({ searchQuery = '', onUserSelect }) => {
      console.log("Page: onUserSelect", onUserSelect);  // log the onUserSelect prop
